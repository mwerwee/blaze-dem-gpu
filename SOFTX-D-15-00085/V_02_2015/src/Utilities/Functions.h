/*
 * Functions.h (unified host/device)
 *
 * Merged from Utilities/Host/Functions.h and Utilities/Device/Functions.cuh
 * Original author: Nicolin Govender, Jun 5, 2014
 */

#ifndef UNIFIED_FUNCTIONS_H_
#define UNIFIED_FUNCTIONS_H_
...
inline HD float length(float3 v)
{
    return sqrtf(dot(v, v));
}

inline HD float3 zeroF()
{
    float3 c;
    c.x = 0.0f;
    c.y = 0.0f;
...
/*---------------------------------------------------------------------------*/
/* Device-only extended functions                                            */
/*---------------------------------------------------------------------------*/
#ifdef __CUDACC__
...
////////////////////////////////////////////////////////////////////////////////
// Quaternion functions (device only)
////////////////////////////////////////////////////////////////////////////////
